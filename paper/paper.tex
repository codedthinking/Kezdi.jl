...
Research computing is central to the scientific workflow of economists. Yet the most widely used software tools are decades old proprietary languages \cite{koren2022adoption}. Of the 364 replication packages studied by \cite{koren2023replication}, 72\% used Stata and 41\% used MATLAB, while only 3\% contained any Julia code.
